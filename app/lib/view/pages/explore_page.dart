...
import 'package:app/view/pages/job_filters.dart';
...
class _ExplorePageState extends State<ExplorePage> {
  ...
  void _onSwipeCompleted(int index, SwipeDirection direction) {
    ...
    // If user swiped right (applied), increment application counters so
    // the dashboard / MarketSection reflects the new total immediately.
    if (direction == SwipeDirection.right) {
      // Increment total applications
      totalApplicationsNotifier.value = totalApplicationsNotifier.value + 1;
      // Consider new applications as 'pending' by default
      pendingApplicationsNotifier.value = pendingApplicationsNotifier.value + 1;
      // Record this pending application in our state tracker
      ApplicationState.recordApplication();
    }
